    ...
    <section id="projects" className={styles.section}>
      <div className="container">
        <SectionHeader
          ...
          subtitle="Каждая работа — самостоятельное приложение со своим живым сайтом и репозиторием. Открой любую: внутри презентация, word-документ, пояснительная записка, инструкция и исходный код."
        />
